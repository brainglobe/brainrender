...
scene.add(Points(np.load(os.path.join(data_path, 'probe_1_straitum.npy')), name="probe_1", colors="darkred",radius=50))
scene.add(Points(np.load(os.path.join(data_path, 'probe_2_RSC.npy')), name="probe_2", colors="darkred",radius=50))
# render
scene.content
scene.render()
