...
We have recently released a new version of `brainrender`, version 2.0 (:tada:). This consists of an entire re-writing of the entire library to make the code cleaner, more compact. easier to read and easier to use.
