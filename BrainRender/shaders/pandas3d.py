...
class ToonMaker(ShowBase):
    ...
    def __init__(self):
        ...
        self.character.loadModel('/Users/federicoclaudi/Dropbox (UCL - SWC)/Rotation_vte/analysis_metadata/anatomy/OtherMeshes/nik-dragon.egg.pz')
        self.character.reparentTo(render)
        self.character.loadAnims({'win': '/Users/federicoclaudi/Dropbox (UCL - SWC)/Rotation_vte/analysis_metadata/anatomy/OtherMeshes/nik-dragon.egg.pz'})
